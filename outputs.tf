output "data_protection_backup_policy_data_lake_storages_id" {
  ...
  value       = { for k, v in azurerm_data_protection_backup_policy_data_lake_storage.data_protection_backup_policy_data_lake_storages : k => v.id if v.id != null && length(v.id) > 0 }
}
output "data_protection_backup_policy_data_lake_storages_backup_schedule" {
  ...
  value       = { for k, v in azurerm_data_protection_backup_policy_data_lake_storage.data_protection_backup_policy_data_lake_storages : k => v.backup_schedule if v.backup_schedule != null && length(v.backup_schedule) > 0 }
}
output "data_protection_backup_policy_data_lake_storages_data_protection_backup_vault_id" {
  ...
  value       = { for k, v in azurerm_data_protection_backup_policy_data_lake_storage.data_protection_backup_policy_data_lake_storages : k => v.data_protection_backup_vault_id if v.data_protection_backup_vault_id != null && length(v.data_protection_backup_vault_id) > 0 }
}
output "data_protection_backup_policy_data_lake_storages_default_retention_duration" {
  ...
  value       = { for k, v in azurerm_data_protection_backup_policy_data_lake_storage.data_protection_backup_policy_data_lake_storages : k => v.default_retention_duration if v.default_retention_duration != null && length(v.default_retention_duration) > 0 }
}
output "data_protection_backup_policy_data_lake_storages_name" {
  ...
  value       = { for k, v in azurerm_data_protection_backup_policy_data_lake_storage.data_protection_backup_policy_data_lake_storages : k => v.name if v.name != null && length(v.name) > 0 }
}
output "data_protection_backup_policy_data_lake_storages_retention_rule" {
  ...
  value       = { for k, v in azurerm_data_protection_backup_policy_data_lake_storage.data_protection_backup_policy_data_lake_storages : k => v.retention_rule if v.retention_rule != null && length(v.retention_rule) > 0 }
}
output "data_protection_backup_policy_data_lake_storages_time_zone" {
  ...
  value       = { for k, v in azurerm_data_protection_backup_policy_data_lake_storage.data_protection_backup_policy_data_lake_storages : k => v.time_zone if v.time_zone != null && length(v.time_zone) > 0 }
}
